...
public class orbitController: MonoBehaviour
{
    ...
    //private int leftMouseButton = 0; // Left button
    private int rightMouseButton = 1; // Right button
    private int middleMouseButton = 2; // Middle button
    ...
    {
        //// zoom
        //if (Input.GetMouseButton(leftMouseButton) && Input.GetKey(KeyCode.LeftAlt) && Input.GetKey(KeyCode.LeftControl))
        //{
        ...
        //else if (Input.GetMouseButton(leftMouseButton) && Input.GetKey(KeyCode.LeftControl))
